...
class _PaginaHeaderState extends ModularState<PaginaHeader, MepsController> {
  @override
  Widget build(BuildContext context) {
   return Observer(builder: (_){
     return controller.mepsHeadersTrailers != null && controller.qpaginaHeader>0
         ? Row(
       ...
       children: [
         ...
         : controller.mepsHeadersTrailers != null && controller.qpaginaHeader==0?Text("Nenhum Header Encontrado"): Container();
